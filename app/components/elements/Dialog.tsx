...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cnBase(
      'fixed inset-0 z-[9998] cursor-pointer bg-black/[0.6] backdrop-blur-lg duration-100 transition-all data-[state=closed]:animate-fadeOut data-[state=open]:animate-fadeIn',
      className,
    )}
    {...props}
  />
...
>(({ className, children, hideCloseButton, container, ...props }, ref) => (
  <DialogPrimitive.Portal container={container}>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cnBase(
        'fixed top-1/2 left-1/2 z-[9999] mt-[-5vh] max-h-[85vh] min-h-[150px] min-w-[250px] translate-x-[-50%] translate-y-[-50%] rounded-lg border border-neutral-100 bg-content1 !p-6 shadow-lg shadow-background/[0.6] will-change-transform focus:outline-none data-[state=closed]:animate-fadeOut data-[state=open]:animate-fadeIn',
        className,
      )}
      {...props}
    >
