  ...
  variants: {
    color: {
      neutral: {
        track: 'bg-neutral-50',
        range: 'bg-neutral',
        thumb: 'border-neutral-foreground',
      },
      primary: {
        track: 'bg-primary-50',
        range: 'bg-primary',
        thumb: 'border-primary-foreground',
      },
      secondary: {
        track: 'bg-secondary-50',
        range: 'bg-secondary',
        thumb: 'border-secondary-foreground',
      },
      success: {
        track: 'bg-success-50',
        range: 'bg-success',
        thumb: 'border-success-foreground',
      },
      warning: {
        track: 'bg-warning-50',
        range: 'bg-warning',
        thumb: 'border-warning-foreground',
      },
      danger: {
        track: 'bg-danger-50',
        range: 'bg-danger',
        thumb: 'border-danger-foreground',
      },
      gradient: {
        track: 'bg-neutral-50',
