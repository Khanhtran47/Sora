...
const BottomNav = (props: IBottomNavProps) => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 z-[4000] flex h-16 w-full flex-row flex-nowrap items-center justify-around border-t border-border bg-background/[0.6] py-2 drop-shadow-md backdrop-blur-md sm:hidden"
    >
      <NavLink
        to="/"
        className={({ isActive }) =>
