...
export const meta = mergeMeta(() => [
  { title: 'Sora - Trending Today' },
  { name: 'keywords', content: 'trending, today' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/trending/today' },
  { property: 'og:title', content: 'Sora - Trending Today' },
  { name: 'description', content: 'Trending Today' },
  { property: 'og:description', content: 'Trending Today' },
  { name: 'twitter:title', content: 'Sora - Trending Today' },
  { name: 'twitter:description', content: 'Trending Today' },
]);
