    ...
    />
      ...
      return (
        <svg
          ...
          {...props}
        >
          <Circle1Light color={fill} strokeWidth={
      1.5} />
        </svg>
      );
        case 'circle2':
      ...
      return (
        <svg
          ...
          {...props}
        >
          <Circle2Light color={fill} strokeWidth={
      1.5} />
        </svg>
      );
        default:
      ...
      Circle1Bold.propTypes = {
        color : PropTypes.string,
      };
      Circle2Bold.propTypes = {
        color : PropTypes.string,
      };
      ...
      Circle1Light.propTypes = {
        color : PropTypes.string,
      };
      Circle2Light.propTypes = {
        color : PropTypes.string,
      };
