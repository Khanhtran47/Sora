...
const SunIcon = ({
  ...
  if (filled) {
    return (
        <svg width = {size || width || 24} height =
             {size || height || 24} viewBox = "0 0 24 24" {...props}>
        <g fill = {fill}><path d = "M19 12a7 7 0 11-7-7 7 7 0 017 7z" />
        <path d =
  ...
  fill = {fill} d =
      ...
      ></path><
      path
  fill = {fill} transform = "rotate(-45.001 18.008 5.99)"
  d = "M16.508 4.99H19.509V6.99H16.508z" >
      ...
      ></path><
      path
  fill = {fill} transform = "rotate(134.999 18.008 18.01)"
