...
export const synthwaveTheme = createTheme({
  ...
  theme: {
    colors: {
      ...
      foreground: '#d1c7db',
      backgroundContrast: '#20134e',
      backgroundContrastAlpha: 'rgb(32, 19, 78, 0.6)',
      backgroundContrastLight: 'rgb(32, 19, 78, 0.2)',
      backgroundTransparent: 'rgba(255, 255, 255, 0)',
      textAlpha: 'rgba(236, 237, 238, 0.6)',

      // brand colors
      primaryLight: '#FCCCDD',
      primaryLightHover: '#F7B0D1',
      primaryLightActive: '#F09ACA',
      primaryLightContrast: '#C658AB',
      primary: '#C658AB',
      primaryBorder: '#E779C1',
      primaryBorderHover: '#C658AB',
      primarySolidHover: '#A63C96',
      primarySolidContrast: '$white',
      primaryShadow: '#E779C1',
      ...
      warning: '#f3cc30',
      error: '#e24056',
      gradient: 'linear-gradient(112deg,#409ED0 -20.3%, #C658AB 70.46%)',
      link: '#B11B98',
    },
  },
  className: 'synthwave',
